<?php require_once 'header.php'; ?>
    ...
    <section id="page-hero">
        <div class="slide fullFirstScreen" style="background-image: url('img/background-page-home.jpg');">
            <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="team-search title-light-black">
                        ...
                        <a href="#" class="main-btn bg-gold text-white bg-hover-light-black text-hover-gold"><i class="bi bi-search"></i>BUSCAR</a>
                    </div>
                </div>
            </div>
            <div class="spacer-60"></div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="pub-card">
                        <div class="pub-card-img">
                            ...
                            <img src="img/placeholder-publicacoes.jpg" alt="">
                        </div>
